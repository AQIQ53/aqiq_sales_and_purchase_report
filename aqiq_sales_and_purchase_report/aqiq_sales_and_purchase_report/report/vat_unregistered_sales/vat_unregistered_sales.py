...
def get_data(conditions):
    ...
    #         where s.docstatus=1 and c.custom_unregistered=1 and i.item_tax_template NOT IN ('Zero Rated - IG', 'Zero Rated - IAL','Exempt - IG','Exempt - IAL') {} group by s.customer order by 1""".format(
    #         conditions
    #     ),
    #     as_dict=1,
    # )
